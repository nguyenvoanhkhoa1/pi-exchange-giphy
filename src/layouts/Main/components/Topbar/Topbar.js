    ...
    <div className="container mx-auto px-4 sm:px-6 xl:px-0 xl:max-w-6xl">
      <div className="my-3 sticky rounded flex flex-wrap top-0 left-0 h-[52px] p-0 m-0 z-0 gap-3">
        <div className="grow border-0 h-[52px] z-[1] flex">
          <form className=" flex grow relative items-center rounded overflow-hidden">
            <div>
              <div className=" select-none overflow-hidden bg-white h-full left-0 z-0 top-0 text-[#a6a6a6] absolute w-full tracking-wide text-lg">
                <div class=" translate-y-0 animate-[5s_ease_0s_infinite_normal_none_running]">
            ...
            <input
              ...
              autoCorrect="off"
              autoComplete="off"
              className=" bg-[#fff] appearance-none rounded-none w-full border-0 m-0 z-[2] float-left relative h-[52px] tracking-wide text-lg p-5 focus-visible:outline-none"
